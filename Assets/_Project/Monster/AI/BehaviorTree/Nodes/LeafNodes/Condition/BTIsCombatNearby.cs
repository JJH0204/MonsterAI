...
namespace Monster.AI.BehaviorTree.Nodes
{
    ...
    public class BTIsCombatNearby : BTCondition
    {
        protected override bool CheckCondition(NodeContext context)
        {
            ...
            if (blackboard.CharData == null) return false;
            if (blackboard.CharData.maxDetectiveRange <= 0f) return false;
                
            float detectionRange = blackboard.CharData.maxDetectiveRange;
