...
namespace AI
{
    public sealed class AIController : MonoBehaviour
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            if (blackboard.Agent is not null && blackboard.DefaultStats is not null && blackboard.DefaultStats.DetectionRange > 0f)
            {
                // Gizmos의 색상을 설정
                Gizmos.color = Color.red;
                Gizmos.DrawWireSphere(blackboard.Agent.transform.position, blackboard.DefaultStats.DetectionRange);
            }
